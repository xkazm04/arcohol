...
export function CreditCard({ balance, accountId }: CreditCardProps) {
  return (
    <div className="relative aspect-[1.586/1] rounded-2xl p-6 flex flex-col justify-between overflow-hidden shadow-2xl group transition-transform hover:scale-[1.01]">
      ...
      <div className="relative z-10 flex justify-between items-start">
        ...
        <svg className="w-8 h-8 text-cyan-400" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 7l10 5 10-5-10-5zm0 9l2.5-1.25L12 8.5l-2.5 1.25L12 11zm0 2.5l-5-2.5-5 2.5L12 22l10-8.5-5-2.5-5 2.5z" /></svg>
      </div>
